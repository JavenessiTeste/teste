...

{
    ...
    if($_POST['TIPO_CADASTRO'] == 'VEND'){
        $criterios .= retornaCriterioRelatorio('PS1100.TIPO_CADASTRO','=',aspas("Cadastro_Vendedores"),'','N');
    }
    if($_POST['TIPO_CADASTRO'] == 'CORR'){
        $criterios .= retornaCriterioRelatorio('PS1100.TIPO_CADASTRO','=',aspas("Cadastro_Corretoras"),'','N');
    }
    if($_POST['TIPO_CADASTRO'] == 'OUTR'){
        $criterios .= retornaCriterioRelatorio('PS1100.TIPO_CADASTRO','=',aspas("Cadastro_Demais_Comissionaveis"),'','N');
    }
