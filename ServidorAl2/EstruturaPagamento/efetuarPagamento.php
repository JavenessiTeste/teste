...
<ul class="nav bg-light nav-pills rounded nav-fill mb-3" role="tablist">
	...
	<!--<li class="nav-item">
		<a class="nav-link" data-toggle="pill" href="#nav-tab-paypal" onclick="tipoPag('')>
		<i class="fas fa-money-check"></i> Boleto Bancário</a></li>-->
	<li class="nav-item">
		<a class="nav-link" data-toggle="pill" href="#nav-tab-bank" onclick="tipoPag('DE')">
		<i class="fas fa-money-check-alt"></i> Cartão de Débito</a></li>
</ul>
...
<div class="tab-pane fade" id="nav-tab-paypal">
	<div  class="payment-form">
	  ...
	  <div  class="form-group-btn">
		<button  id="gerar-boleto" onClick="pagamentoBoleto('<?php echo $_GET['tipo']; ?>','<?php echo $_GET['reg']; ?>');" class="botaoForm">Gerar boleto</button>
	  </div>
	</div>
	<div  class="payment-form">
		  <ul  class="boleto-informations">
			...
			<li >Se o boleto não for pago até a data de vencimento, o pedido será cancelado.</li>
			<li >O pedido será liberado para a entrega após a instituição financeira confirmar o pagamento, o que pode ser feito em até 3 dias úteis.</li>
		  </ul>
	</div>
</div>
