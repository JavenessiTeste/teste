...
textoImagemEspacamento($imagem, $tamanhoLetra, 0, 38, 971, $cor,$normal,$nomePrestador,5);						       	      	  // 26
...
<?php
echo '<img width="850px" height="582px" src="data:image/jpeg;base64,' . base64_encode( $dadoImagem ) . '" />';
?>
</body>
</html>
