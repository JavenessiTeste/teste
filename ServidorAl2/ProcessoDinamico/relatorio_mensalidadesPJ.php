...
$queryDetFat  = " SELECT PS1021.CODIGO_ASSOCIADO, PS1000.CODIGO_TITULAR, PS1000.NOME_ASSOCIADO, PS1000.NUMERO_CPF, PS1045.NOME_PARENTESCO, PS1021.VALOR_CONVENIO, PS1021.VALOR_FATURA, PS1021.VALOR_ADICIONAL ";
...
while($rowDetFat = jn_fetch_object($resDetFat))
{
	...
	$fatura[$i]['Numero Cpf']			    = $rowDetFat->NUMERO_CPF;
			...
			<tr>
				...
				';
					if($_SESSION['codigoSmart'] != '3423'){//Plena
						$html .= '<strong>Vlr. Conv.: </strong>' . toMoeda($rowFat->VALOR_CONVENIO);
					}
				...
				';
					if($_SESSION['codigoSmart'] != '3423'){//Plena
						$html .= '<strong>Vlr. Adic.: </strong>' . toMoeda($rowFat->VALOR_ADICIONAL);
					}
