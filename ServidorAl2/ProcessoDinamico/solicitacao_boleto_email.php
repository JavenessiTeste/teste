   ...
   <body style="text-align:left; font-size: 12px;" leftmargin="10">
		<form class="form-horizontal" name="formDefault" method="post" id="formDefault" accept-charset="utf-8" enctype="multipart/form-data" target="_self">
			<div id="paginaSemAssinatura">
				<img height="90%" weidth="100%" src="retornaImagem.php?tp=imagemBoletoPlena<?php echo '&email='.$email.'&codArea='.$codArea.'&telefone='.$telefone; ?>">
			</div>
			<div id="paginaJaAssinado">
				<img height="90%" weidth="100%" src="retornaImagem.php?tp=imagemBoletoPlena<?php echo '&email='.$email.'&codArea='.$codArea.'&assinado=JaAssinado&telefone='.$telefone; ?>">
			</div>
			<div id="conteudoImpressao" style="display:none;">
				<img height="90%" weidth="100%" src="retornaImagem.php?tp=imagemBoletoPlena<?php echo '&email='.$email.'&codArea='.$codArea.'&assinado=SIM&telefone='.$telefone; ?>">
			</div>
			<br />
