...
if ($_SESSION['perfilOperador'] == 'BENEFICIARIO' || $_SESSION['perfilOperador'] == 'BENEFICIARIO_CPF')
    $query .= 'select numero_cpf DOCUMENTO from ps1000 where codigo_associado = ' . aspas($_SESSION['codigoIdentificacao']);
else
    $query .= 'select NUMERO_CNPJ DOCUMENTO from ps1010 where codigo_empresa = ' . aspas($_SESSION['codigoIdentificacao']);
