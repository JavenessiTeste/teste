...
$query = "Select Ps1020.Codigo_Empresa, Ps1020.Codigo_Associado, Ps1020.Data_Pagamento, Ps1020.Data_Vencimento, Ps1020.Data_Emissao, Ps1020.Valor_Fatura, ";
...
$dadosboleto["instrucoes3"] = "Apos vencimento cobrar mora diária de R$ " . toMoeda(($rowPs1020->VALOR_FATURA * $result[0]['PERCENTUAL_MORA_DIARIA']), false, false);
$dadosboleto["instrucoes4"] = "Apos vencimento cobrar multa de R$ " . toMoeda(($rowPs1020->VALOR_FATURA * $result[0]['PERCENTUAL_MULTA_PADRAO']), false, false);
...
// NÃO ALTERAR!
ob_start();
include("include/funcoes_itau_PlaneSeg.php"); 
include("include/layout_itau_PlaneSeg.php");
