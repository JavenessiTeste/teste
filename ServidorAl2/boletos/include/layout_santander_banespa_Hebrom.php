...
<page backtop="7mm" backbottom="7mm" backleft="11mm" backright="10mm" style="font-size: 9px; font-weight: normal; color:#000033;">
			...
			<td valign="top" class="cp">
				<div align="left" class="cabecalho">
					<ul>
						...
						<br>
						<li>
						Caso tenha problemas ao imprimir, copie a seqüencia num&eacute;rica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
	...
	<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
	  <tr>
		<?php
			...
			if ($grupoPessoa != 1) {
				$logoOperadora = getLogoOperadora('../../Site/assets/img');
		
		?>
		
			<td width=41 class=cp>
				<img src="<?php echo $logoOperadora ?>" alt="Hebrom" width="150" height="47">
			</td>
		<?php
		}		
		?>
	  ...
	  <tr>
		<td>
			<img src="../../Site/assets/img/topoBoleto.png" width="100%">
		</td>
	  </tr>
	</table>
	-->
	...
	<?php
	$nomeImagem = 'topoBoleto';
	if($grupoANAF){
		$nomeImagem = 'topoBoletoAnaf';
	}
	echo '<img src="../../Site/assets/img/'.$nomeImagem.'.png" width="500" height="93">';
	?>
	...
	<?php	
		...
		echo '	<br />';
		echo '	Atrasos acumulados nos &uacute;ltimos 12 (doze) meses: ' . $dadosboleto["quantidade"];
		echo '	<br />';
	...
	<table>
		<tr>
			<td valign="top" class="cp">
				Se desejar ir direto ao site de seu banco, utilize os ícones abaixo
				<br><br>
			</td>
		</tr>
		...
		<tr>
			<td >
				<a href="https://www.itau.com.br" target="_blank"><img src="imagens/logoitau.jpg" alt="Itau" width="100" ></a>
				<a href="https://www.bb.com.br/pbb/pagina-inicial#/" target="_blank"><img src="imagens/logobb.jpg" alt="Banco do Brasil" width="100" ></a>
				<a href="https://www.caixa.gov.br/Paginas/home-caixa.aspx" target="_blank"><img src="imagens/logocaixa.jpg" alt="Caixa" width="100" ></a>
				<a href="https://www.santander.com.br/" target="_blank"><img src="imagens/logosantander.jpg" alt="Santander" width="100" ></a>
				<a href="https://banco.bradesco/html/classic/index.shtm" target="_blank"><img src="imagens/logobradesco.jpg" alt="Bradesco" width="100" ></a>
			</td>
		</tr>
	</table>
