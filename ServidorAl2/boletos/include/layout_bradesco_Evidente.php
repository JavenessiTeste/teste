...
<page backtop="7mm" backbottom="7mm" backleft="11mm" backright="10mm" style="font-size: 9px; font-weight: normal; color:#000033;">
	...
	<table cellspacing=0 cellpadding=0 border=0>
		...
		<tr>
			...
			<td class=ct>Agência/Código Beneficiário</td>
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>Vencimento</td>
		</tr>
		<tr>
			<td height=12><img src=imagens/1.png width=1 height=12></td>
			<td colspan=7 class=cp><?php $cedente = explode('COOPERATIVA EVIDENTE ', $dadosboleto["cedente"]); echo $cedente[1]; ?></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			...
			<td width=472 rowspan=9 valign=top>
				<span class=ct>Instruções (Texto de responsabilidade do Beneficiário)</span><br>
				&nbsp;<br>
				<span class=cp><?php echo $dadosboleto["instrucoes1"] . '<br>' . $dadosboleto["instrucoes2"] . '<br>' . $dadosboleto["instrucoes3"] . '<br>' . $dadosboleto["instrucoes4"] . '<br>' . $dadosboleto["instrucoes5"] . '<br>' . $dadosboleto["instrucoes6"] ?></span>
			</td>
