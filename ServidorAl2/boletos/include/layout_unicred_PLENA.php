...
<page backtop="7mm" backbottom="7mm" backleft="11mm" backright="10mm" style="font-size: 9px; font-weight: normal; color:#000033;">
		...
		<tr>
			<td valign="top" class="cp">
				<div align="left" class="cabecalho">
					<ul>
						<li>
						Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal ou alta (Nao use modo economico).
						</li>
						<br>
						<li>Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens minimas a esquerda e a direita do formulario.
						</li>
						<br>
						<li>Corte na linha indicada. Nao rasure, risque, fure ou dobre a regiao onde se encontra o codigo de barras.
						</li>
						<br>
						...
						<br>
						<li>
						Caso tenha problemas ao imprimir, copie a sequencia numerica abaixo e pague no caixa eletronico ou no internet banking:<br><br>
						<span style="font-size: 13px; font-weight: normal; color:#000033; padding:10px;">
						<div>Linha Digitavel: &nbsp;<?php echo $dadosboleto["linha_digitavel"]?></div>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td width=140 class=cp><img src="imagens/logounicred.jpg" alt="sicredi" width="150" height="27"></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		...
		<tr>
			...
			<td class=ct>Agencia/Codigo do Cedente</td>
			<td><img src=imagens/1.png width=1 height=13></td>
		...
		<tr>
			...
			<td class=cp><?php echo $dadosboleto["agencia"] .'/' . $dadosboleto["conta"] .'-'.$dadosboleto["conta_dv"]?></td>
			<td><img src=imagens/1.png width=1 height=12></td>
		...
		<tr>
			...
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>Numero do documento</td>
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>Especie</td>
			<td><img src=imagens/1.png width=1 height=13></td>
		...
		<tr>
			...
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>(-) Outras deducoes</td>
			<td><img src=imagens/1.png width=1 height=13></td>
			<td colspan=3 class=ct>(+) Mora / Multa</td>
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>(+) Outros acrescimos</td>
			<td><img src=imagens/1.png width=1 height=13></td>
		...
		<tr>
			...
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>Nosso numero</td>
		</tr>
		<tr>
			<td height=12><img src=imagens/1.png width=1 height=12></td>
			<td colspan=7 class=cp><?php echo $dadosboleto["sacado"]?></td>
			<td colspan=2 class=cp><?php echo $dadosboleto["Documento"]?></td>
			<td><img src=imagens/1.png width=1 height=12></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			...
			<td width=94 class=ct>Autenticacao mecanica</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
	...
	<table cellspacing=0 cellpadding=0 border=0 height="2">
		...
		<tr>
			<td height=12><img src=imagens/1.png width=1 height=12></td>
			<td colspan=11 class=cp>Pagavel em qualquer Banco ate o vencimento.</td>
			<td><img src=imagens/1.png width=1 height=12></td>
			<td class=cp align=right><?php echo $dadosboleto["data_vencimento"]?></td>
		</tr>
		...
		<tr>
			...
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>Agencia/Codigo cedente</td>
		</tr>
		<tr>
			<td height=12><img src=imagens/1.png width=1 height=12></td>
			<td colspan=11  class=cp><?php echo $dadosboleto["cedente"]?></td>
			<td><img src=imagens/1.png width=1 height=12></td>
			<td class=cp align=right><?php echo $dadosboleto["agencia"] .'/' . $dadosboleto["conta"] .'-'.$dadosboleto["conta_dv"]?></td>
		</tr>
		<tr><td colspan=14 height=1><img src=imagens/2.png width=666 height=1></td></tr>
		<tr>
			<td height=13><img src=imagens/1.png width=1 height=13></td>
			...
			<td><img src=imagens/1.png width=1 height=13></td>
			<td colspan=3 class=ct>Numero do documento</td>
			<td><img src=imagens/1.png width=1 height=13></td>
			<td class=ct>Especie doc.</td>
			<td><img src=imagens/1.png width=1 height=13></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			...
			<td width=472 rowspan=9 valign=top>
				<span class=ct>Instrucoes (Texto de responsabilidade do cedente)</span><br>
				&nbsp;<br>
		...
		<tr>
			...
			<td class=cp><?php echo $dadosboleto["sacado"] . ' - CPF/CNPJ: ' . $dadosboleto["Documento"] . '<br>' . $dadosboleto["endereco1"] . '<br>' . $dadosboleto["endereco2"]?></td>
			<td valign=bottom><img src=imagens/1.png width=1 height=13></td>
			<td valign=bottom><span class=ct>Cod. baixa</span></td>
		</tr>
		<tr><td colspan=4 height=1><img src=imagens/2.png width=666 height=1></td></tr>
	</table>
	<br />
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			...
			<td width=333 class=ct align=right>Autenticacao mecanica - <span class=cp>Ficha de Compensacao</span></td>
		</tr>
