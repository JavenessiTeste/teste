...
if($numRegistro){
	...
	if($_SESSION['perfilOperador'] == 'BENEFICIARIO' || $_SESSION['perfilOperador'] == 'BENEFICIARIO_CPF'){
		...
		header("Location: http://app.plenasaude.com.br/AliancaAppNet2/ServidorAl2/EstruturaEspecifica/boletoSemParametro.php");
		return false;
	}
}else{
	exit;
...
$dadosboleto["carteira_descricao"] = "COBRAN&Ccedil;A SIMPLES";  // Descrição da Carteira
