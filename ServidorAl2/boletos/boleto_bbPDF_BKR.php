...
$dadosboleto["demonstrativo2"] = "Taxa banc&aacute;ria - R$ ".$taxa_boleto;
...
$dadosboleto["instrucoes4"] = "APOS O VENCIMENTO COBRAR MULTA DE 2% <BR> APOS O VENCIMENTO COBRAR MORA DIARIA DE 0,033% ";
...
if($rowPs1000->CODIGO_CONVENIO){
	$dadosboleto["convenio"] = $rowPs1000->CODIGO_CONVENIO;  // Num do conv�nio - REGRA: 6 ou 7 ou 8 d�gitos
}else{
	$dadosboleto["convenio"] = "3120889";  // Num do conv�nio - REGRA: 6 ou 7 ou 8 d�gitos
}
//$dadosboleto["convenio"] = "3120889";  // Num do conv�nio - REGRA: 6 ou 7 ou 8 d�gitos
